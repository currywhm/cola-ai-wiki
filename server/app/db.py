...
_SQLITE_MIGRATIONS: dict[str, dict[str, str]] = {
    ...
    'knowledge_bases': {'last_used_at': "TEXT DEFAULT ''", 'visibility': "TEXT NOT NULL DEFAULT 'private'", 'category': "TEXT DEFAULT ''", 'subscribers': "INTEGER DEFAULT 0", 'mirror_of': "TEXT DEFAULT ''", 'mirror_owner': "TEXT DEFAULT ''", 'mirror_state': "TEXT DEFAULT ''", 'mirror_token': "TEXT DEFAULT ''", 'mirror_at': "TEXT DEFAULT ''"},
    'conversations': {'memory_summary': "TEXT NOT NULL DEFAULT ''", 'folder_id': "TEXT DEFAULT ''", 'pinned': "INTEGER NOT NULL DEFAULT 0", 'pinned_at': "TEXT DEFAULT ''"},
...
_MYSQL_MIGRATIONS: dict[str, dict[str, str]] = {
    ...
    'knowledge_bases': {'last_used_at': "VARCHAR(64) NOT NULL DEFAULT ''", 'visibility': "VARCHAR(16) NOT NULL DEFAULT 'private'", 'category': "VARCHAR(128) NOT NULL DEFAULT ''", 'subscribers': "INT NOT NULL DEFAULT 0", 'mirror_of': "VARCHAR(32) NOT NULL DEFAULT ''", 'mirror_owner': "VARCHAR(32) NOT NULL DEFAULT ''", 'mirror_state': "VARCHAR(32) NOT NULL DEFAULT ''", 'mirror_token': "VARCHAR(64) NOT NULL DEFAULT ''", 'mirror_at': "VARCHAR(64) NOT NULL DEFAULT ''"},
    'conversations': {'memory_summary': "TEXT NULL", 'folder_id': "VARCHAR(32) NOT NULL DEFAULT ''", 'pinned': "INT NOT NULL DEFAULT 0", 'pinned_at': "VARCHAR(64) NOT NULL DEFAULT ''"},
