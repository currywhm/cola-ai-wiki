// 服务说明页：关于 / 数据管理 / 隐私安全 / 小程序隐私保护指引 / 用户服务协议 /
// 软件许可及服务协议 / 会员服务条款，正文全部由后端下发
...
const KNOWN_IDS = ['about', 'data', 'privacy', 'guide', 'terms', 'license', 'plan']
...
Page({
  ...
  openDoc(e: any) {
    ...
    wx.redirectTo({ url: `/pages/legal/index?type=${id}` })
  },
  ...
  onShareAppMessage() {
    return { title: this.data.title, path: `/pages/legal/index?type=${this.data.docId}` }
  },
})
